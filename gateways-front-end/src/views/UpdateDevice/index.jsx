...
import { getDevice, updateDevice } from '../../redux/features/Devices/DevicesActions'
...
class UpdateDevice extends Component{
    constructor(props) {
        ...
        this.state = {
            ...
            deviceId: window.location.href.split('/')[4]
        }
    }
    ...
    onSubmitFields(e){
        ...
        this.props.updateDevice(this.state.deviceFields).then(() => this.setState({ navigateToDevices: true }))
    }
...
export default connect(mapStateToProps, { getGateways, updateDevice, getDevice })(UpdateDevice)
